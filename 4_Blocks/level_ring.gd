...
const BLOCK_PLACEMENT: Array[Array] = [
	...
	[PLT_STN, ITM_STN, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_STN], #  1 <-> 17 
	...
	[PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_AIR, ITM_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN], #  7 <-> 23 
	...
	[PLT_STN, PLT_FIR, PLT_AIR, PLT_PLX, PLT_PLX, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN], # 12 <-> 28 
