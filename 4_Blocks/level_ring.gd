...
const JUMP_AND_FIRE: Array[Array] = [
	...
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, OBJ_END], # 30 <-> 14
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_GTW, PLT_GTW, PLT_STN],  # 31 <-> 15
	[PLT_STN] #  0 <-> 16 
]
...
const BLOCK_PLACEMENT: Array[Array] = [
	...
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_STN], #  1 <-> 17 
	...
	[PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN], # 17 <->  1
	[PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN], # 18 <->  2
	[PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN], # 19 <->  3
	[PLT_STN], # 20 <->  4
	[PLT_STN], # 21 <->  5
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN], # 22 <->  6
	[PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_STN], # 23 <->  7
	[PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN], # 24 <->  8
	[PLT_STN, PLT_FIR], # 25 <->  9
	[PLT_STN, PLT_FIR], # 26 <-> 10
...
const SHIFTING: Array[Array] = [
	...
	[PLT_PLX, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_STN], #  1 <-> 17 
	...
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_PLX, PLT_STN, PLT_STN, PLT_STN, OBJ_END], # 22 <->  6
	...
	[PLT_PLX, PLT_AIR, PLT_AIR, PLT_AIR, PLT_PLX, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN]  # 31 <-> 15
]
...
const GATEWAY: Array[Array] = [
	...
	[PLT_STN, PLT_GTW, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN], # 28 <-> 12
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN], # 29 <-> 13
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_STN, PLT_STN, PLT_STN, PLT_STN, OBJ_END], # 30 <-> 14
	[PLT_STN, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_AIR, PLT_STN]  # 31 <-> 15
]
